...
int main()
{
    ...
    cout << "Hello dear user, please enter the order of the fib num you want to calc: ";
    cin >> num;
    cout << "The fibonacci number with the order " << GREEN << BOLD << num << RESET << " is " << BLUE << BOLD << rec_fib(num) << RESET << " (done using naive approach)" << endl;
    cout << "it costed us " << BOLD << RED << get_calls() << RESET << " calls, and it reached a maximum recursion depth of " << BOLD << RED << get_max_depth() << RESET << endl << endl;
    SEPARATE
    reset_counters();
    cout << "The fibonacci number with the order " << GREEN << BOLD << num << RESET << " is " << BLUE << BOLD << dp_fib(num) << RESET << " (done using memoization (dynamic programming))" << endl;
    cout << "it costed us " << BOLD << RED << get_calls() << RESET << " calls, and it reached a maximum recursion depth of " << BOLD << RED << get_max_depth() << RESET << endl << endl;
    SEPARATE
    reset_counters();

    cout << "The fibonacci number with the order " << GREEN << BOLD << num << RESET << " is " << BLUE << BOLD << matrix_fib(num) << RESET << " (done using matrix multiplication)" << endl;
    cout << "it costed us " << BOLD << RED << get_calls() << RESET << " calls, and it reached a maximum recursion depth of " << BOLD << RED << get_max_depth() << RESET << endl << endl;
    reset_counters();
}